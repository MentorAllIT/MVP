...
const { Math: M } = globalThis as any; // silence some TS libs
const { randFloat, randFloatSpread } = MathUtils;

// a bunch of re-usable vectors (GC friendly)
const F = new Vector3();
const I = new Vector3();
const O = new Vector3();
const V = new Vector3();
...
interface BallpitProps {
  className?: string;
  followCursor?: boolean;
  [key: string]: any; // pass-through config (colors, count, gravity, etc.)
}
